...
import it.polimi.dima.polisocial.messageEndpoint.MessageEndpoint;
import it.polimi.dima.polisocial.messageEndpoint.model.CollectionResponseMessageData;
import it.polimi.dima.polisocial.messageEndpoint.model.MessageData;
				...
				case MotionEvent.ACTION_DOWN:
					...
					|| GCMIntentService.PROJECT_NUMBER.length() == 0) {
						...
						try {
							...
							Log.e(GCMActivity.class.getName(),
