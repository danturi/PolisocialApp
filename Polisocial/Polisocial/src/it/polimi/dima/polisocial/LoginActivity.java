				...
				Request meRequest=Request.newMeRequest(session, new GraphUserCallback()
				{
					...
					public void onCompleted(GraphUser user, Response response)
					{
						...
						{	
							...
							String dateBirthFB = (String) user.getProperty("birthday");
							if (dateBirthFB==null){
								poliuser.setDatebirth(null);
							}else {
								SimpleDateFormat date =new SimpleDateFormat("MM/dd/yyyy");
								date.setTimeZone(TimeZone.getTimeZone("GMT"));
								
								try {
									Date userDate = date.parse(dateBirthFB);
									
									poliuser.setDatebirth(new DateTime(userDate));
