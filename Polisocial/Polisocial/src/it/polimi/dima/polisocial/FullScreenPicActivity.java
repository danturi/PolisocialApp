...
import it.polimi.dima.polisocial.util.SystemUiHider;
...
public class FullScreenPicActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ImageView contentView = (ImageView)findViewById(R.id.full_screenImage);
		byte[] byteArrayImage = getIntent().getByteArrayExtra("picInByte");
