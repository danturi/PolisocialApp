...
public class Hitonendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetUserHitOn getUserHitOn(java.lang.Long userId) throws java.io.IOException {
    GetUserHitOn result = new GetUserHitOn(userId);
    initialize(result);
    return result;
  }
  ...
  public class GetUserHitOn extends HitonendpointRequest<it.polimi.dima.polisocial.entity.hitonendpoint.model.CollectionResponseHitOn> {
    ...
    private static final String REST_PATH = "collectionresponse_hiton/{userId}";
     ...
     * @since 1.13
     */
    protected GetUserHitOn(java.lang.Long userId) {
    ...
    public GetUserHitOn setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }
