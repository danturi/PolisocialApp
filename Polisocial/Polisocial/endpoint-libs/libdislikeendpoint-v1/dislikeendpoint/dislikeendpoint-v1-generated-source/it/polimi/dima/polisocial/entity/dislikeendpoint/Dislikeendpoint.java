...
public class Dislikeendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public InsertDisLike insertDisLike(it.polimi.dima.polisocial.entity.dislikeendpoint.model.DisLike content) throws java.io.IOException {
    InsertDisLike result = new InsertDisLike(content);
    initialize(result);
    return result;
  }
  ...
  public class InsertDisLike extends DislikeendpointRequest<it.polimi.dima.polisocial.entity.dislikeendpoint.model.DisLike> {
     ...
     * @since 1.13
     */
    protected InsertDisLike(it.polimi.dima.polisocial.entity.dislikeendpoint.model.DisLike content) {
