...
public class Rentalendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "findLocationAndAddRental".
   *
   * This request holds the parameters needed by the rentalendpoint server.  After setting any
   * optional parameters, call the {@link FindLocationAndAddRental#execute()} method to invoke the
   * remote operation.
   *
   * @param content the {@link it.polimi.dima.polisocial.entity.rentalendpoint.model.Rental}
   * @return the request
   */
  public FindLocationAndAddRental findLocationAndAddRental(it.polimi.dima.polisocial.entity.rentalendpoint.model.Rental content) throws java.io.IOException {
    FindLocationAndAddRental result = new FindLocationAndAddRental(content);
    initialize(result);
    return result;
  }

  public class FindLocationAndAddRental extends RentalendpointRequest<it.polimi.dima.polisocial.entity.rentalendpoint.model.Rental> {

    private static final String REST_PATH = "findLocationAndAddRental";
     ...
     * optional parameters, call the {@link FindLocationAndAddRental#execute()} method to invoke the
     * remote operation. <p> {@link FindLocationAndAddRental#initialize(com.google.api.client.googleap
     ...
     * @since 1.13
     */
    protected FindLocationAndAddRental(it.polimi.dima.polisocial.entity.rentalendpoint.model.Rental content) {
      super(Rentalendpoint.this, "POST", REST_PATH, content, it.polimi.dima.polisocial.entity.rentalendpoint.model.Rental.class);
    }

    @Override
    public FindLocationAndAddRental setAlt(java.lang.String alt) {
      return (FindLocationAndAddRental) super.setAlt(alt);
    }

    @Override
    public FindLocationAndAddRental setFields(java.lang.String fields) {
      return (FindLocationAndAddRental) super.setFields(fields);
    }

    @Override
    public FindLocationAndAddRental setKey(java.lang.String key) {
      return (FindLocationAndAddRental) super.setKey(key);
    }

    @Override
    public FindLocationAndAddRental setOauthToken(java.lang.String oauthToken) {
      return (FindLocationAndAddRental) super.setOauthToken(oauthToken);
    }

    @Override
    public FindLocationAndAddRental setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (FindLocationAndAddRental) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public FindLocationAndAddRental setQuotaUser(java.lang.String quotaUser) {
      return (FindLocationAndAddRental) super.setQuotaUser(quotaUser);
    }

    @Override
    public FindLocationAndAddRental setUserIp(java.lang.String userIp) {
      return (FindLocationAndAddRental) super.setUserIp(userIp);
    }

    @Override
    public FindLocationAndAddRental set(String parameterName, Object value) {
      return (FindLocationAndAddRental) super.set(parameterName, value);
    }
  }
