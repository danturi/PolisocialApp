...
public class Poliuserendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class CheckCredentials extends PoliuserendpointRequest<it.polimi.dima.polisocial.entity.poliuserendpoint.model.ResponseObject> {
  ...
  public class CheckForDuplicateEmail extends PoliuserendpointRequest<it.polimi.dima.polisocial.entity.poliuserendpoint.model.ResponseObject> {
   ...
   * @return the request
   */
  public CheckForDuplicateUsername checkForDuplicateUsername(java.lang.String nickname) throws java.io.IOException {
    CheckForDuplicateUsername result = new CheckForDuplicateUsername(nickname);
    initialize(result);
    return result;
  }

  public class CheckForDuplicateUsername extends PoliuserendpointRequest<it.polimi.dima.polisocial.entity.poliuserendpoint.model.ResponseObject> {

    private static final String REST_PATH = "checkForDuplicateUsername/{nickname}";
     ...
     * @since 1.13
     */
    protected CheckForDuplicateUsername(java.lang.String nickname) {
    	super(Poliuserendpoint.this, "GET", REST_PATH, null, it.polimi.dima.polisocial.entity.poliuserendpoint.model.ResponseObject.class);
    ...
    public CheckForDuplicateUsername setNickname(java.lang.String nickname) {
