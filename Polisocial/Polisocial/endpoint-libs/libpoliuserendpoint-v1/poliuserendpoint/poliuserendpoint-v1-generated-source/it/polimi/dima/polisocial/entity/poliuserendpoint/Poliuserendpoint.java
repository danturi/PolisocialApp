...
public class Poliuserendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public CheckCredentials checkCredentials(java.lang.String nickname, java.lang.String password) throws java.io.IOException {
    CheckCredentials result = new CheckCredentials(nickname, password);
    initialize(result);
    return result;
  }
  ...
  public class CheckCredentials extends PoliuserendpointRequest<it.polimi.dima.polisocial.entity.poliuserendpoint.model.PoliUser> {
    ...
    private static final String REST_PATH = "checkCredentials/{nickname}/{password}";
     ...
     * @since 1.13
     */
    protected CheckCredentials(java.lang.String nickname, java.lang.String password) {
      super(Poliuserendpoint.this, "POST", REST_PATH, null, it.polimi.dima.polisocial.entity.poliuserendpoint.model.PoliUser.class);
    ...
    public CheckCredentials setNickname(java.lang.String nickname) {
