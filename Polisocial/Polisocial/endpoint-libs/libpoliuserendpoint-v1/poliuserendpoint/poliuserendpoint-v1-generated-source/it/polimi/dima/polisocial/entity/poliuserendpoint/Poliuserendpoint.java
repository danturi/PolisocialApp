...
public class Poliuserendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetPictureUser extends PoliuserendpointRequest<it.polimi.dima.polisocial.entity.poliuserendpoint.model.ResponseObject> {
    ...
    private static final String REST_PATH = "getPictureUser";
  ...
  /**
   * Create a request for the method "updateFacultyPoliUser".
   *
   * This request holds the parameters needed by the poliuserendpoint server.  After setting any
   * optional parameters, call the {@link UpdateFacultyPoliUser#execute()} method to invoke the remote
   * operation.
   *
   * @param faculty
   * @param userId
   * @return the request
   */
  public UpdateFacultyPoliUser updateFacultyPoliUser(java.lang.String faculty, java.lang.Long userId) throws java.io.IOException {
    UpdateFacultyPoliUser result = new UpdateFacultyPoliUser(faculty, userId);
    initialize(result);
    return result;
  }

  public class UpdateFacultyPoliUser extends PoliuserendpointRequest<Void> {

    private static final String REST_PATH = "updateFacultyPoliUser";

    /**
     * Create a request for the method "updateFacultyPoliUser".
     *
     * This request holds the parameters needed by the the poliuserendpoint server.  After setting any
     * optional parameters, call the {@link UpdateFacultyPoliUser#execute()} method to invoke the
     * remote operation. <p> {@link UpdateFacultyPoliUser#initialize(com.google.api.client.googleapis.
     * services.AbstractGoogleClientRequest)} must be called to initialize this instance immediately
     * after invoking the constructor. </p>
     *
     * @param faculty
     ...
     * @since 1.13
     */
    protected UpdateFacultyPoliUser(java.lang.String faculty, java.lang.Long userId) {
      super(Poliuserendpoint.this, "PUT", REST_PATH, null, Void.class);
      this.faculty = com.google.api.client.util.Preconditions.checkNotNull(faculty, "Required parameter faculty must be specified.");
      this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
    }

    @Override
    public UpdateFacultyPoliUser setAlt(java.lang.String alt) {
      return (UpdateFacultyPoliUser) super.setAlt(alt);
    }

    @Override
    public UpdateFacultyPoliUser setFields(java.lang.String fields) {
      return (UpdateFacultyPoliUser) super.setFields(fields);
    }

    @Override
    public UpdateFacultyPoliUser setKey(java.lang.String key) {
      return (UpdateFacultyPoliUser) super.setKey(key);
    }

    @Override
    public UpdateFacultyPoliUser setOauthToken(java.lang.String oauthToken) {
      return (UpdateFacultyPoliUser) super.setOauthToken(oauthToken);
    }

    @Override
    public UpdateFacultyPoliUser setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (UpdateFacultyPoliUser) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public UpdateFacultyPoliUser setQuotaUser(java.lang.String quotaUser) {
      return (UpdateFacultyPoliUser) super.setQuotaUser(quotaUser);
    }

    @Override
    public UpdateFacultyPoliUser setUserIp(java.lang.String userIp) {
      return (UpdateFacultyPoliUser) super.setUserIp(userIp);
    }
    ...
    public UpdateFacultyPoliUser setFaculty(java.lang.String faculty) {
      this.faculty = faculty;
      return this;
    }
    ...
    public UpdateFacultyPoliUser setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }

    @Override
    public UpdateFacultyPoliUser set(String parameterName, Object value) {
      return (UpdateFacultyPoliUser) super.set(parameterName, value);
    }
  }
