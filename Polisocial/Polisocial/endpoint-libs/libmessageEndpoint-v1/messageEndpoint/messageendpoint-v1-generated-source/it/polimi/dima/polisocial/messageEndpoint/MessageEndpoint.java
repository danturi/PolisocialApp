...
public class MessageEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public SendMessageToDevice sendMessageToDevice(java.lang.String message, java.lang.Long postId, java.lang.String postType, java.lang.Long user, it.polimi.dima.polisocial.messageEndpoint.model.DeviceInfo content) throws java.io.IOException {
    SendMessageToDevice result = new SendMessageToDevice(message, postId, postType, user, content);
    initialize(result);
    return result;
  }
  ...
  public class SendMessageToDevice extends MessageEndpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected SendMessageToDevice(java.lang.String message, java.lang.Long postId, java.lang.String postType, java.lang.Long user, it.polimi.dima.polisocial.messageEndpoint.model.DeviceInfo content) {
