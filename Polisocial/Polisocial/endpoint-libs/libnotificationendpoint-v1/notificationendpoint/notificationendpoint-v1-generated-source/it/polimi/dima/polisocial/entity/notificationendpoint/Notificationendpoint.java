...
public class Notificationendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getCountUnreadTypeNotificationForUser".
   *
   * This request holds the parameters needed by the notificationendpoint server.  After setting any
   * optional parameters, call the {@link GetCountUnreadTypeNotificationForUser#execute()} method to
   ...
   * @return the request
   */
  public GetCountUnreadTypeNotificationForUser getCountUnreadTypeNotificationForUser(java.lang.String type, java.lang.Long userId) throws java.io.IOException {
    GetCountUnreadTypeNotificationForUser result = new GetCountUnreadTypeNotificationForUser(type, userId);
    initialize(result);
    return result;
  }

  public class GetCountUnreadTypeNotificationForUser extends NotificationendpointRequest<it.polimi.dima.polisocial.entity.notificationendpoint.model.ResponseObject> {

    private static final String REST_PATH = "getCountUnreadTypeNotificationForUser";

    /**
     * Create a request for the method "getCountUnreadTypeNotificationForUser".
     *
     * This request holds the parameters needed by the the notificationendpoint server.  After setting
     * any optional parameters, call the {@link GetCountUnreadTypeNotificationForUser#execute()}
     * method to invoke the remote operation. <p> {@link GetCountUnreadTypeNotificationForUser#initial
     * ize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must be called to
     ...
     * @since 1.13
     */
    protected GetCountUnreadTypeNotificationForUser(java.lang.String type, java.lang.Long userId) {
      super(Notificationendpoint.this, "GET", REST_PATH, null, it.polimi.dima.polisocial.entity.notificationendpoint.model.ResponseObject.class);
    ...
    @Override
    public GetCountUnreadTypeNotificationForUser setAlt(java.lang.String alt) {
      return (GetCountUnreadTypeNotificationForUser) super.setAlt(alt);
    }

    @Override
    public GetCountUnreadTypeNotificationForUser setFields(java.lang.String fields) {
      return (GetCountUnreadTypeNotificationForUser) super.setFields(fields);
    }

    @Override
    public GetCountUnreadTypeNotificationForUser setKey(java.lang.String key) {
      return (GetCountUnreadTypeNotificationForUser) super.setKey(key);
    }

    @Override
    public GetCountUnreadTypeNotificationForUser setOauthToken(java.lang.String oauthToken) {
      return (GetCountUnreadTypeNotificationForUser) super.setOauthToken(oauthToken);
    }

    @Override
    public GetCountUnreadTypeNotificationForUser setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetCountUnreadTypeNotificationForUser) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetCountUnreadTypeNotificationForUser setQuotaUser(java.lang.String quotaUser) {
      return (GetCountUnreadTypeNotificationForUser) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetCountUnreadTypeNotificationForUser setUserIp(java.lang.String userIp) {
      return (GetCountUnreadTypeNotificationForUser) super.setUserIp(userIp);
    }
    ...
    public GetCountUnreadTypeNotificationForUser setType(java.lang.String type) {
      this.type = type;
      return this;
    }
    ...
    public GetCountUnreadTypeNotificationForUser setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }

    @Override
    public GetCountUnreadTypeNotificationForUser set(String parameterName, Object value) {
      return (GetCountUnreadTypeNotificationForUser) super.set(parameterName, value);
    }
  }
  ...
  /**
   * Create a request for the method "getNotificationForPost".
   *
   * This request holds the parameters needed by the notificationendpoint server.  After setting any
   * optional parameters, call the {@link GetNotificationForPost#execute()} method to invoke the
   * remote operation.
   *
   * @param postId
   * @param userId
   * @return the request
   */
  public GetNotificationForPost getNotificationForPost(java.lang.Long postId, java.lang.Long userId) throws java.io.IOException {
    GetNotificationForPost result = new GetNotificationForPost(postId, userId);
    initialize(result);
    return result;
  }

  public class GetNotificationForPost extends NotificationendpointRequest<it.polimi.dima.polisocial.entity.notificationendpoint.model.Notification> {

    private static final String REST_PATH = "getNotificationForPost";

    /**
     * Create a request for the method "getNotificationForPost".
     *
     * This request holds the parameters needed by the the notificationendpoint server.  After setting
     * any optional parameters, call the {@link GetNotificationForPost#execute()} method to invoke the
     * remote operation. <p> {@link GetNotificationForPost#initialize(com.google.api.client.googleapis
     ...
     * @since 1.13
     */
    protected GetNotificationForPost(java.lang.Long postId, java.lang.Long userId) {
      super(Notificationendpoint.this, "GET", REST_PATH, null, it.polimi.dima.polisocial.entity.notificationendpoint.model.Notification.class);
    ...
    @Override
    public GetNotificationForPost setAlt(java.lang.String alt) {
      return (GetNotificationForPost) super.setAlt(alt);
    }

    @Override
    public GetNotificationForPost setFields(java.lang.String fields) {
      return (GetNotificationForPost) super.setFields(fields);
    }

    @Override
    public GetNotificationForPost setKey(java.lang.String key) {
      return (GetNotificationForPost) super.setKey(key);
    }

    @Override
    public GetNotificationForPost setOauthToken(java.lang.String oauthToken) {
      return (GetNotificationForPost) super.setOauthToken(oauthToken);
    }

    @Override
    public GetNotificationForPost setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetNotificationForPost) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetNotificationForPost setQuotaUser(java.lang.String quotaUser) {
      return (GetNotificationForPost) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetNotificationForPost setUserIp(java.lang.String userIp) {
      return (GetNotificationForPost) super.setUserIp(userIp);
    }
    ...
    public GetNotificationForPost setPostId(java.lang.Long postId) {
      this.postId = postId;
      return this;
    }
    ...
    public GetNotificationForPost setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }

    @Override
    public GetNotificationForPost set(String parameterName, Object value) {
      return (GetNotificationForPost) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "getUserNotification".
   *
   * This request holds the parameters needed by the notificationendpoint server.  After setting any
   * optional parameters, call the {@link GetUserNotification#execute()} method to invoke the remote
   * operation.
   *
   * @param userId
   * @return the request
   */
  public GetUserNotification getUserNotification(java.lang.Long userId) throws java.io.IOException {
    GetUserNotification result = new GetUserNotification(userId);
    initialize(result);
    return result;
  }

  public class GetUserNotification extends NotificationendpointRequest<it.polimi.dima.polisocial.entity.notificationendpoint.model.CollectionResponseNotification> {

    private static final String REST_PATH = "collectionresponse_notification/{userId}";

    /**
     * Create a request for the method "getUserNotification".
     *
     * This request holds the parameters needed by the the notificationendpoint server.  After setting
     * any optional parameters, call the {@link GetUserNotification#execute()} method to invoke the
     * remote operation. <p> {@link GetUserNotification#initialize(com.google.api.client.googleapis.se
     ...
     * @since 1.13
     */
    protected GetUserNotification(java.lang.Long userId) {
    ...
    @Override
    public GetUserNotification setAlt(java.lang.String alt) {
      return (GetUserNotification) super.setAlt(alt);
    }

    @Override
    public GetUserNotification setFields(java.lang.String fields) {
      return (GetUserNotification) super.setFields(fields);
    }

    @Override
    public GetUserNotification setKey(java.lang.String key) {
      return (GetUserNotification) super.setKey(key);
    }

    @Override
    public GetUserNotification setOauthToken(java.lang.String oauthToken) {
      return (GetUserNotification) super.setOauthToken(oauthToken);
    }

    @Override
    public GetUserNotification setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetUserNotification) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetUserNotification setQuotaUser(java.lang.String quotaUser) {
      return (GetUserNotification) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetUserNotification setUserIp(java.lang.String userIp) {
      return (GetUserNotification) super.setUserIp(userIp);
    }
    ...
    public GetUserNotification setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }
    ...
    public GetUserNotification setCursor(java.lang.String cursor) {
      this.cursor = cursor;
      return this;
    }
    ...
    public GetUserNotification setLimit(java.lang.Integer limit) {
      this.limit = limit;
      return this;
    }

    @Override
    public GetUserNotification set(String parameterName, Object value) {
      return (GetUserNotification) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "haveHitOnNotificationForPost".
   *
   * This request holds the parameters needed by the notificationendpoint server.  After setting any
   * optional parameters, call the {@link HaveHitOnNotificationForPost#execute()} method to invoke the
   * remote operation.
   *
   * @param postId
   * @param userId
   * @return the request
   */
  public HaveHitOnNotificationForPost haveHitOnNotificationForPost(java.lang.Long postId, java.lang.Long userId) throws java.io.IOException {
    HaveHitOnNotificationForPost result = new HaveHitOnNotificationForPost(postId, userId);
    initialize(result);
    return result;
  }

  public class HaveHitOnNotificationForPost extends NotificationendpointRequest<it.polimi.dima.polisocial.entity.notificationendpoint.model.ResponseObject> {

    private static final String REST_PATH = "haveHitOnNotificationForPost/{postId}/{userId}";

    /**
     * Create a request for the method "haveHitOnNotificationForPost".
     *
     * This request holds the parameters needed by the the notificationendpoint server.  After setting
     * any optional parameters, call the {@link HaveHitOnNotificationForPost#execute()} method to
     * invoke the remote operation. <p> {@link HaveHitOnNotificationForPost#initialize(com.google.api.
     ...
     * @since 1.13
     */
    protected HaveHitOnNotificationForPost(java.lang.Long postId, java.lang.Long userId) {
      super(Notificationendpoint.this, "POST", REST_PATH, null, it.polimi.dima.polisocial.entity.notificationendpoint.model.ResponseObject.class);
      this.postId = com.google.api.client.util.Preconditions.checkNotNull(postId, "Required parameter postId must be specified.");
      this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
    }

    @Override
    public HaveHitOnNotificationForPost setAlt(java.lang.String alt) {
      return (HaveHitOnNotificationForPost) super.setAlt(alt);
    }

    @Override
    public HaveHitOnNotificationForPost setFields(java.lang.String fields) {
      return (HaveHitOnNotificationForPost) super.setFields(fields);
    }

    @Override
    public HaveHitOnNotificationForPost setKey(java.lang.String key) {
      return (HaveHitOnNotificationForPost) super.setKey(key);
    }

    @Override
    public HaveHitOnNotificationForPost setOauthToken(java.lang.String oauthToken) {
      return (HaveHitOnNotificationForPost) super.setOauthToken(oauthToken);
    }

    @Override
    public HaveHitOnNotificationForPost setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (HaveHitOnNotificationForPost) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public HaveHitOnNotificationForPost setQuotaUser(java.lang.String quotaUser) {
      return (HaveHitOnNotificationForPost) super.setQuotaUser(quotaUser);
    }

    @Override
    public HaveHitOnNotificationForPost setUserIp(java.lang.String userIp) {
      return (HaveHitOnNotificationForPost) super.setUserIp(userIp);
    }
    ...
    public HaveHitOnNotificationForPost setPostId(java.lang.Long postId) {
      this.postId = postId;
      return this;
    }
    ...
    public HaveHitOnNotificationForPost setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }

    @Override
    public HaveHitOnNotificationForPost set(String parameterName, Object value) {
      return (HaveHitOnNotificationForPost) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "haveNotificationForPost".
   *
   * This request holds the parameters needed by the notificationendpoint server.  After setting any
   * optional parameters, call the {@link HaveNotificationForPost#execute()} method to invoke the
   * remote operation.
   *
   * @param postId
   * @param userId
   * @return the request
   */
  public HaveNotificationForPost haveNotificationForPost(java.lang.Long postId, java.lang.Long userId) throws java.io.IOException {
    HaveNotificationForPost result = new HaveNotificationForPost(postId, userId);
    initialize(result);
    return result;
  }

  public class HaveNotificationForPost extends NotificationendpointRequest<it.polimi.dima.polisocial.entity.notificationendpoint.model.ResponseObject> {

    private static final String REST_PATH = "haveNotificationForPost/{postId}/{userId}";

    /**
     * Create a request for the method "haveNotificationForPost".
     *
     * This request holds the parameters needed by the the notificationendpoint server.  After setting
     * any optional parameters, call the {@link HaveNotificationForPost#execute()} method to invoke
     * the remote operation. <p> {@link HaveNotificationForPost#initialize(com.google.api.client.googl
     ...
     * @since 1.13
     */
    protected HaveNotificationForPost(java.lang.Long postId, java.lang.Long userId) {
      super(Notificationendpoint.this, "POST", REST_PATH, null, it.polimi.dima.polisocial.entity.notificationendpoint.model.ResponseObject.class);
      this.postId = com.google.api.client.util.Preconditions.checkNotNull(postId, "Required parameter postId must be specified.");
      this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
    }
    ...
    @Override
    public HaveNotificationForPost setAlt(java.lang.String alt) {
      return (HaveNotificationForPost) super.setAlt(alt);
    }

    @Override
    public HaveNotificationForPost setFields(java.lang.String fields) {
      return (HaveNotificationForPost) super.setFields(fields);
    }

    @Override
    public HaveNotificationForPost setKey(java.lang.String key) {
      return (HaveNotificationForPost) super.setKey(key);
    }

    @Override
    public HaveNotificationForPost setOauthToken(java.lang.String oauthToken) {
      return (HaveNotificationForPost) super.setOauthToken(oauthToken);
    }

    @Override
    public HaveNotificationForPost setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (HaveNotificationForPost) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public HaveNotificationForPost setQuotaUser(java.lang.String quotaUser) {
      return (HaveNotificationForPost) super.setQuotaUser(quotaUser);
    }

    @Override
    public HaveNotificationForPost setUserIp(java.lang.String userIp) {
      return (HaveNotificationForPost) super.setUserIp(userIp);
    }
    ...
    public HaveNotificationForPost setPostId(java.lang.Long postId) {
      this.postId = postId;
      return this;
    }
    ...
    public HaveNotificationForPost setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }

    @Override
    public HaveNotificationForPost set(String parameterName, Object value) {
      return (HaveNotificationForPost) super.set(parameterName, value);
    }
  }
