...
public class Notificationendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getCountUnreadNotificationForUser".
   *
   * This request holds the parameters needed by the notificationendpoint server.  After setting any
   * optional parameters, call the {@link GetCountUnreadNotificationForUser#execute()} method to
   * invoke the remote operation.
   *
   * @param userId
   * @return the request
   */
  public GetCountUnreadNotificationForUser getCountUnreadNotificationForUser(java.lang.Long userId) throws java.io.IOException {
    GetCountUnreadNotificationForUser result = new GetCountUnreadNotificationForUser(userId);
    initialize(result);
    return result;
  }

  public class GetCountUnreadNotificationForUser extends NotificationendpointRequest<it.polimi.dima.polisocial.entity.notificationendpoint.model.ResponseObject> {

    private static final String REST_PATH = "getCountUnreadNotificationForUser";

    /**
     * Create a request for the method "getCountUnreadNotificationForUser".
     *
     * This request holds the parameters needed by the the notificationendpoint server.  After setting
     * any optional parameters, call the {@link GetCountUnreadNotificationForUser#execute()} method to
     * invoke the remote operation. <p> {@link GetCountUnreadNotificationForUser#initialize(com.google
     ...
     * @since 1.13
     */
    protected GetCountUnreadNotificationForUser(java.lang.Long userId) {
    ...
    @Override
    public GetCountUnreadNotificationForUser setAlt(java.lang.String alt) {
      return (GetCountUnreadNotificationForUser) super.setAlt(alt);
    }

    @Override
    public GetCountUnreadNotificationForUser setFields(java.lang.String fields) {
      return (GetCountUnreadNotificationForUser) super.setFields(fields);
    }

    @Override
    public GetCountUnreadNotificationForUser setKey(java.lang.String key) {
      return (GetCountUnreadNotificationForUser) super.setKey(key);
    }

    @Override
    public GetCountUnreadNotificationForUser setOauthToken(java.lang.String oauthToken) {
      return (GetCountUnreadNotificationForUser) super.setOauthToken(oauthToken);
    }

    @Override
    public GetCountUnreadNotificationForUser setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetCountUnreadNotificationForUser) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetCountUnreadNotificationForUser setQuotaUser(java.lang.String quotaUser) {
      return (GetCountUnreadNotificationForUser) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetCountUnreadNotificationForUser setUserIp(java.lang.String userIp) {
      return (GetCountUnreadNotificationForUser) super.setUserIp(userIp);
    }
    ...
    public GetCountUnreadNotificationForUser setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }

    @Override
    public GetCountUnreadNotificationForUser set(String parameterName, Object value) {
      return (GetCountUnreadNotificationForUser) super.set(parameterName, value);
    }
  }
