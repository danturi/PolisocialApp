...
public class Foursquareendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "foursquareendpoint/v1/searchVenues/";
  ...
  public class SearchVenues extends FoursquareendpointRequest<Void> {

    private static final String REST_PATH = "{ll}";
