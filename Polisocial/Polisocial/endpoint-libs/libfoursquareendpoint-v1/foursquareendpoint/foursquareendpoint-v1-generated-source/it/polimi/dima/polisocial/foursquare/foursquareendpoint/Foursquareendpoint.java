...
public class Foursquareendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public PerformTokenRequest performTokenRequest(java.lang.String code) throws java.io.IOException {
    PerformTokenRequest result = new PerformTokenRequest(code);
    initialize(result);
    return result;
  }
  ...
  public class PerformTokenRequest extends FoursquareendpointRequest<Void> {
    ...
    private static final String REST_PATH = "performTokenRequest/{code}";
     ...
     * @since 1.13
     */
    protected PerformTokenRequest(java.lang.String code) {
  ...
  /**
   * Create a request for the method "provaToken".
   *
   * This request holds the parameters needed by the foursquareendpoint server.  After setting any
   * optional parameters, call the {@link ProvaToken#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public ProvaToken provaToken() throws java.io.IOException {
    ProvaToken result = new ProvaToken();
    initialize(result);
    return result;
  }

  public class ProvaToken extends FoursquareendpointRequest<Void> {

    private static final String REST_PATH = "provaToken";

    /**
     * Create a request for the method "provaToken".
     *
     * This request holds the parameters needed by the the foursquareendpoint server.  After setting
     * any optional parameters, call the {@link ProvaToken#execute()} method to invoke the remote
     * operation. <p> {@link
     * ProvaToken#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected ProvaToken() {
      super(Foursquareendpoint.this, "POST", REST_PATH, null, Void.class);
    }

    @Override
    public ProvaToken setAlt(java.lang.String alt) {
      return (ProvaToken) super.setAlt(alt);
    }

    @Override
    public ProvaToken setFields(java.lang.String fields) {
      return (ProvaToken) super.setFields(fields);
    }

    @Override
    public ProvaToken setKey(java.lang.String key) {
      return (ProvaToken) super.setKey(key);
    }

    @Override
    public ProvaToken setOauthToken(java.lang.String oauthToken) {
      return (ProvaToken) super.setOauthToken(oauthToken);
    }

    @Override
    public ProvaToken setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ProvaToken) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ProvaToken setQuotaUser(java.lang.String quotaUser) {
      return (ProvaToken) super.setQuotaUser(quotaUser);
    }

    @Override
    public ProvaToken setUserIp(java.lang.String userIp) {
      return (ProvaToken) super.setUserIp(userIp);
    }

    @Override
    public ProvaToken set(String parameterName, Object value) {
      return (ProvaToken) super.set(parameterName, value);
    }
  }
  ...
  public class SearchVenues extends FoursquareendpointRequest<it.polimi.dima.polisocial.foursquare.foursquareendpoint.model.StringObjectCollection> {
    ...
    protected SearchVenues(java.lang.String ll) {
      super(Foursquareendpoint.this, "POST", REST_PATH, null, it.polimi.dima.polisocial.foursquare.foursquareendpoint.model.StringObjectCollection.class);
