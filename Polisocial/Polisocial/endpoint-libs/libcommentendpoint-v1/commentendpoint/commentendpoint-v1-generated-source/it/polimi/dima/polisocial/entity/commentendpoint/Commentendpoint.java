...
public class Commentendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getNumbPostComments".
   *
   * This request holds the parameters needed by the commentendpoint server.  After setting any
   * optional parameters, call the {@link GetNumbPostComments#execute()} method to invoke the remote
   * operation.
   *
   * @param postId
   * @return the request
   */
  public GetNumbPostComments getNumbPostComments(java.lang.Long postId) throws java.io.IOException {
    GetNumbPostComments result = new GetNumbPostComments(postId);
    initialize(result);
    return result;
  }

  public class GetNumbPostComments extends CommentendpointRequest<it.polimi.dima.polisocial.entity.commentendpoint.model.ResponseObject> {
     ...
     * This request holds the parameters needed by the the commentendpoint server.  After setting any
     * optional parameters, call the {@link GetNumbPostComments#execute()} method to invoke the remote
     * operation. <p> {@link GetNumbPostComments#initialize(com.google.api.client.googleapis.services.
     ...
     * @since 1.13
     */
    protected GetNumbPostComments(java.lang.Long postId) {
      super(Commentendpoint.this, "GET", REST_PATH, null, it.polimi.dima.polisocial.entity.commentendpoint.model.ResponseObject.class);
    ...
    @Override
    public GetNumbPostComments setAlt(java.lang.String alt) {
      return (GetNumbPostComments) super.setAlt(alt);
    }

    @Override
    public GetNumbPostComments setFields(java.lang.String fields) {
      return (GetNumbPostComments) super.setFields(fields);
    }

    @Override
    public GetNumbPostComments setKey(java.lang.String key) {
      return (GetNumbPostComments) super.setKey(key);
    }

    @Override
    public GetNumbPostComments setOauthToken(java.lang.String oauthToken) {
      return (GetNumbPostComments) super.setOauthToken(oauthToken);
    }

    @Override
    public GetNumbPostComments setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetNumbPostComments) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetNumbPostComments setQuotaUser(java.lang.String quotaUser) {
      return (GetNumbPostComments) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetNumbPostComments setUserIp(java.lang.String userIp) {
      return (GetNumbPostComments) super.setUserIp(userIp);
    }
    ...
    public GetNumbPostComments setPostId(java.lang.Long postId) {
      this.postId = postId;
      return this;
    }

    @Override
    public GetNumbPostComments set(String parameterName, Object value) {
      return (GetNumbPostComments) super.set(parameterName, value);
    }
  }
   ...
   * @return the request
   */
  public GetPostComments getPostComments(java.lang.Long postId) throws java.io.IOException {
    GetPostComments result = new GetPostComments(postId);
    initialize(result);
    return result;
  }
  ...
  public class GetPostComments extends CommentendpointRequest<it.polimi.dima.polisocial.entity.commentendpoint.model.CollectionResponseComment> {
    ...
    private static final String REST_PATH = "collectionresponse_comment/{postId}";
     ...
     * @since 1.13
     */
    protected GetPostComments(java.lang.Long postId) {
    ...
    public GetPostComments setPostId(java.lang.Long postId) {
      this.postId = postId;
      return this;
    }
  ...
  /**
   * Create a request for the method "sendNotification".
   *
   * This request holds the parameters needed by the commentendpoint server.  After setting any
   ...
   * @return the request
   */
  public SendNotification sendNotification(it.polimi.dima.polisocial.entity.commentendpoint.model.Comment content) throws java.io.IOException {
    SendNotification result = new SendNotification(content);
    initialize(result);
    return result;
  }

  public class SendNotification extends CommentendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected SendNotification(it.polimi.dima.polisocial.entity.commentendpoint.model.Comment content) {
      super(Commentendpoint.this, "POST", REST_PATH, content, Void.class);
    }
