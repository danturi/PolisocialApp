 ...
 * on 2014-09-26 at 06:17:09 UTC 
 * Modify at your own risk.
 */

package it.polimi.dima.polisocial.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetDeviceInfo extends DeviceinfoendpointRequest<it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected GetDeviceInfo(java.lang.String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo.class);
   ...
   * operation.
   *
   * @param content the {@link it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo.class);
    }
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<it.polimi.dima.polisocial.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
    ...
    protected ListDeviceInfo() {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, it.polimi.dima.polisocial.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
    }
  ...
  /**
   * Create a request for the method "sendToUser".
   *
   * This request holds the parameters needed by the deviceinfoendpoint server.  After setting any
   * optional parameters, call the {@link SendToUser#execute()} method to invoke the remote operation.
   *
   * @param userId
   * @param postId
   * @param postType
   ...
   * @return the request
   */
  public SendToUser sendToUser(java.lang.Long userId, java.lang.Long postId, java.lang.String postType, java.lang.String postTitle) throws java.io.IOException {
    SendToUser result = new SendToUser(userId, postId, postType, postTitle);
    initialize(result);
    return result;
  }

  public class SendToUser extends DeviceinfoendpointRequest<Void> {

    private static final String REST_PATH = "sendToUser/{userId}/{postId}/{postType}/{postTitle}";

    /**
     * Create a request for the method "sendToUser".
     *
     * This request holds the parameters needed by the the deviceinfoendpoint server.  After setting
     * any optional parameters, call the {@link SendToUser#execute()} method to invoke the remote
     * operation. <p> {@link
     * SendToUser#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     ...
     * @since 1.13
     */
    protected SendToUser(java.lang.Long userId, java.lang.Long postId, java.lang.String postType, java.lang.String postTitle) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, null, Void.class);
      ...
      this.postTitle = com.google.api.client.util.Preconditions.checkNotNull(postTitle, "Required parameter postTitle must be specified.");
    }

    @Override
    public SendToUser setAlt(java.lang.String alt) {
      return (SendToUser) super.setAlt(alt);
    }

    @Override
    public SendToUser setFields(java.lang.String fields) {
      return (SendToUser) super.setFields(fields);
    }

    @Override
    public SendToUser setKey(java.lang.String key) {
      return (SendToUser) super.setKey(key);
    }

    @Override
    public SendToUser setOauthToken(java.lang.String oauthToken) {
      return (SendToUser) super.setOauthToken(oauthToken);
    }

    @Override
    public SendToUser setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SendToUser) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SendToUser setQuotaUser(java.lang.String quotaUser) {
      return (SendToUser) super.setQuotaUser(quotaUser);
    }

    @Override
    public SendToUser setUserIp(java.lang.String userIp) {
      return (SendToUser) super.setUserIp(userIp);
    }
    ...
    public SendToUser setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }
    ...
    public SendToUser setPostId(java.lang.Long postId) {
      this.postId = postId;
      return this;
    }
    ...
    public SendToUser setPostType(java.lang.String postType) {
    ...
    public SendToUser setPostTitle(java.lang.String postTitle) {
      this.postTitle = postTitle;
      return this;
    }

    @Override
    public SendToUser set(String parameterName, Object value) {
      return (SendToUser) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "sendToUserHitOn".
   *
   * This request holds the parameters needed by the deviceinfoendpoint server.  After setting any
   * optional parameters, call the {@link SendToUserHitOn#execute()} method to invoke the remote
   * operation.
   *
   * @param postId
   * @return the request
   */
  public SendToUserHitOn sendToUserHitOn(java.lang.Long postId) throws java.io.IOException {
    SendToUserHitOn result = new SendToUserHitOn(postId);
    initialize(result);
    return result;
  }

  public class SendToUserHitOn extends DeviceinfoendpointRequest<Void> {

    private static final String REST_PATH = "sendToUserHitOn/{postId}";

    /**
     * Create a request for the method "sendToUserHitOn".
     *
     * This request holds the parameters needed by the the deviceinfoendpoint server.  After setting
     * any optional parameters, call the {@link SendToUserHitOn#execute()} method to invoke the remote
     * operation. <p> {@link SendToUserHitOn#initialize(com.google.api.client.googleapis.services.Abst
     ...
     * @since 1.13
     */
    protected SendToUserHitOn(java.lang.Long postId) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, null, Void.class);
      this.postId = com.google.api.client.util.Preconditions.checkNotNull(postId, "Required parameter postId must be specified.");
    }

    @Override
    public SendToUserHitOn setAlt(java.lang.String alt) {
      return (SendToUserHitOn) super.setAlt(alt);
    }

    @Override
    public SendToUserHitOn setFields(java.lang.String fields) {
      return (SendToUserHitOn) super.setFields(fields);
    }

    @Override
    public SendToUserHitOn setKey(java.lang.String key) {
      return (SendToUserHitOn) super.setKey(key);
    }

    @Override
    public SendToUserHitOn setOauthToken(java.lang.String oauthToken) {
      return (SendToUserHitOn) super.setOauthToken(oauthToken);
    }

    @Override
    public SendToUserHitOn setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SendToUserHitOn) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SendToUserHitOn setQuotaUser(java.lang.String quotaUser) {
      return (SendToUserHitOn) super.setQuotaUser(quotaUser);
    }

    @Override
    public SendToUserHitOn setUserIp(java.lang.String userIp) {
      return (SendToUserHitOn) super.setUserIp(userIp);
    }
    ...
    public SendToUserHitOn setPostId(java.lang.Long postId) {
      this.postId = postId;
      return this;
    }

    @Override
    public SendToUserHitOn set(String parameterName, Object value) {
      return (SendToUserHitOn) super.set(parameterName, value);
    }
  }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, it.polimi.dima.polisocial.deviceinfoendpoint.model.DeviceInfo.class);
    }
