...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public SendToUser sendToUser(java.lang.Long userId, java.lang.Long postId, java.lang.String postType) throws java.io.IOException {
    SendToUser result = new SendToUser(userId, postId, postType);
    initialize(result);
    return result;
  }
  ...
  public class SendToUser extends DeviceinfoendpointRequest<Void> {
    ...
    private static final String REST_PATH = "sendToUser/{userId}/{postId}/{postType}";
     ...
     * @since 1.13
     */
    protected SendToUser(java.lang.Long userId, java.lang.Long postId, java.lang.String postType) {
