...
public final class PostSpotted extends com.google.api.client.json.GenericJson {
  ...
  private java.lang.Boolean anonimous;

  /**
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private java.lang.Boolean flagAnonimity;
   ...
   */
  public java.lang.Boolean getAnonimous() {
    return anonimous;
  }

  /**
   * @param anonimous anonimous or {@code null} for none
   */
  public PostSpotted setAnonimous(java.lang.Boolean anonimous) {
   ...
   * @return value or {@code null} for none
   */
  public java.lang.Boolean getFlagAnonimity() {
    return flagAnonimity;
  }

  /**
   * @param flagAnonimity flagAnonimity or {@code null} for none
   */
  public PostSpotted setFlagAnonimity(java.lang.Boolean flagAnonimity) {
   ...
   */
  public PostSpotted setKey(Key key) {
    this.key = key;
    return this;
  }
   ...
   */
  public PostSpotted setPhoto(java.lang.String photo) {
    this.photo = photo;
    return this;
  }
   ...
   * @since 1.14
   */
  public PostSpotted encodePhoto(byte[] photo) {
   ...
   */
  public PostSpotted setUserId(java.lang.Integer userId) {
    this.userId = userId;
    return this;
  }
